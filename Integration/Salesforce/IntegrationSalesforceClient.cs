                                ...
                                if (!ErrorFlag && OpportunityMemberListInitial.Count > 0)
                                {
                                    ...
                                    if (!ErrorFlag)
                                    {
                                        ...
                                        OpportunityMemberList = (from om in OpportunityMemberListInitial
                                                                 ...
                                                                 //join ccml in ContactCampaignMemberList on new { crm.ContactId, om.CampaignId } equals new { ccml.ContactId, ccml.CampaignId }    // Modified by Viral Kadiya for PL ticket #2018 - filter Opportunity member list with Campaign Id.
