;(function ( $, window, document, undefined ) {
    ...
    Slidepanel.prototype.init = function () {
        ...
        $(this.$element).on(this.options.event_def, function(e) {           
            e.preventDefault();
        ...
        $('.close-form', this.$panel).unbind(this.options.event_def);
