...
jQuery.fn.extend({
	...
	if ($('.Yes_BudgetCreateEdit').attr('checked') == 'checked') {
	    ...
	    $('.Yes_BudgetView').parent().data('checked', true).css({ backgroundPosition: "left -" + (elmHeight * 2) + "px" });
	    $('.No_BudgetView').attr("checked", false);
	    $('.No_BudgetView').parent().data('checked', false).css({ backgroundPosition: "left 0" });

	}

	if ($('.Yes_ForecastCreateEdit').attr('checked') == 'checked') {
	    $('.Yes_ForecastView').attr("checked", true);
	    $('.Yes_ForecastView').parent().data('checked', true).css({ backgroundPosition: "left -" + (elmHeight * 2) + "px" });
	    $('.No_ForecastView').attr("checked", false);
	    $('.No_ForecastView').parent().data('checked', false).css({ backgroundPosition: "left 0" });
	}
	if ($('.No_BudgetCreateEdit').attr('checked') == 'checked' && $('.No_BudgetView').attr('checked') == 'checked') {
	    $('.No_ForecastCreateEdit').attr("checked", true);
	    $('.No_ForecastCreateEdit').parent().data('checked', true).css({ backgroundPosition: "left -" + (elmHeight * 2) + "px" });
	    $('.Yes_ForecastCreateEdit').attr("checked", false);
	    $('.Yes_ForecastCreateEdit').parent().data('checked', false).css({ backgroundPosition: "left 0" });

	    $('.No_ForecastView').attr("checked", true);
	    $('.No_ForecastView').parent().data('checked', true).css({ backgroundPosition: "left -" + (elmHeight * 2) + "px" });
	    $('.Yes_ForecastView').attr("checked", false);
	    $('.Yes_ForecastView').parent().data('checked', false).css({ backgroundPosition: "left 0" });
