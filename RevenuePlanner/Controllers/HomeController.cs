...
namespace RevenuePlanner.Controllers
{
    ...
    public class HomeController : CommonController
    {
        ...
        [HttpPost]
        [CompressAttribute]
        public JsonResult GetCalendarData(string planIds, string ownerIds, string tactictypeIds, string statusIds, string customFieldIds, string timeframe, string viewBy, string Searchtext = "", string SearchBy="")
        {
            ...
            try
            {
                ...
                resultData = objGrid.GetPlanCalendarData(planIds, ownerIds, tactictypeIds, statusIds, customFieldIds, timeframe, planYear, viewBy, Searchtext, SearchBy);
