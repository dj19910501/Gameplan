-- ===========================================01_Role and User role permissions feature.sql===========================================
...
BEGIN
	...
	SELECT [UserId]
      ,[RoleId]
    FROM [dbo].[User_Application] where ApplicationId in (select ApplicationId from Application where Code='MRP') and UserId in (select userid from [user] where IsDeleted=0)
 	OPEN User_cursor
...
-- ===========================================02_Ticket_517_User_Profile_New_Features_060614_Add_Phone_Field.sql===========================================
...
-- ===========================================02_Updated_Release_Version.sql===========================================
