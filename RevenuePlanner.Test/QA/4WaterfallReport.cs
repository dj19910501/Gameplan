...
namespace RevenuePlanner.Test.QA
{
    ...
    public class WaterfallReport
    {
        ...
        {
            Console.WriteLine("-------------- Monthly CW Report -------------- \n \n");
            ...
            if (IsQuaterly == "Monthly")
            {
                ...
                if (TotalActualList != null && TotalActualList.Count > 0)
                {
                    for (int i = 0; i <= TotalActualList.Count - 1; i++)
                    {
                        ...
                        Assert.AreEqual(Math.Round(Convert.ToDecimal(ActualSeries.data[i + 2].ToString()), 2), Math.Round(SumOfActual, 2));
                        Console.WriteLine("ReportController - GetRevenueData \n Report - Monthly CW Waterfall Report  \n The assert value of monthly actual revenue in graph " + MonthList[i] + " is " + ActualSeries.data[i + 2].ToString() + ".");
                    }
                }
                if (GoalList != null && GoalList.Count > 0)
                {
                    for (int i = 0; i <= GoalList.Count - 1; i++)
                    {
                        ...
                        Assert.AreEqual(Math.Round(Convert.ToDecimal(GoalSeries.data[i + 2].ToString()), 2), Math.Round(SumOfGoal, 2));
                        Console.WriteLine("ReportController - GetRevenueData \n Report - Monthly CW Waterfall Report  \n The assert value of monthly goal in graph " + MonthList[i] + " is " + GoalSeries.data[i + 2].ToString() + ".");
                    }
                }
                if (ProjectedList != null && ProjectedList.Count > 0)
                {
                    for (int i = 0; i <= ProjectedList.Count - 1; i++)
                    {
                        ...
                        Console.WriteLine("ReportController - GetRevenueData \n Report - Monthly CW Waterfall Report  \n The assert value of monthly projected revenue in graph " + MonthList[i] + " is " + projectedSeriesval.ToString() + ".");
                    }
                }
            }
            else
            {
                ...
                if (TotalActualList != null && TotalActualList.Count > 0)
                {
                    for (int i = 1; i <= TotalActualList.Count; i++)
                    {
                        ...
                        Assert.AreEqual(Math.Round(Convert.ToDecimal(ActualSeries.data[i].ToString()), 2), Math.Round(SumOfActual, 2));
                        Console.WriteLine("ReportController - GetRevenueData \n Report - Quarterly CW Waterfall Report  \n The assert value of quarterly actual revenue in graph " + QuarterList[i - 1] + " is " + ActualSeries.data[i].ToString() + ".");
                    }
                }
                if (GoalList != null && GoalList.Count > 0)
                {
                    for (int i = 1; i <= GoalList.Count; i++)
                    {
                        ...
                        Console.WriteLine("ReportController - GetRevenueData \n Report - Quarterly CW Waterfall Report  \n The assert value of monthly goal in graph " + QuarterList[i - 1] + " is " + GoalSeries.data[i].ToString() + ".");
                    }
                }
                //if (ProjectedList != null && ProjectedList.Count > 0)
                //{
                ...
                //        Assert.AreEqual(Math.Round(projectedSeriesval, 2), Math.Round(SumOfProjected, 2));
                //        Console.WriteLine("ReportController - GetRevenueData \n Report - Monthly CW Waterfall Report  \n The assert value of monthly projected revenue in graph " + QuarterList[i] + " is " + projectedSeriesval.ToString() + ".");
                //    }
                //}
            }
        }
        ...
        {
            Console.WriteLine("-------------- Monthly INQ Report -------------- \n \n");
        ...
        public void VerifyWaterfall_INQGraphValue(List<double> ProjectedList, List<string> TotalActualList, List<double> GoalList, lineChartData objlineChartData, string IsQuaterly)
        {
            ...
            if (IsQuaterly == "Monthly")
            {
                Console.WriteLine("\n \n-------------- Monthly INQ Graph Report -------------- \n \n");
                if (TotalActualList != null && TotalActualList.Count > 0)
                {

                    for (int i = 0; i <= TotalActualList.Count - 1; i++)
                    {
                        Assert.AreEqual(Math.Round(Convert.ToDecimal(ActualSeries.data[i + 2].ToString()), 2), Math.Round(Convert.ToDecimal(TotalActualList[i]), 2));
                        Console.WriteLine("ReportController - GetRevenueData \n Report - Monthly Inquiry Waterfall Report  \n The assert value of monthly actual revenue in graph " + MonthList[i] + " is " + ActualSeries.data[i + 2].ToString() + ".");
                    }
                }
                if (GoalList != null && GoalList.Count > 0)
            ...
            else
            {
                ...
                if (TotalActualList != null && TotalActualList.Count > 0)
                {
                    for (int i = 1; i <= TotalActualList.Count; i++)
                    {
                        ...
                        Assert.AreEqual(Math.Round(Convert.ToDecimal(ActualSeries.data[i].ToString()), 2), Math.Round(SumOfActual, 2));
                        Console.WriteLine("ReportController - GetRevenueData \n Report - Quarterly Inquiry Waterfall Report  \n The assert value of quarterly actual revenue in graph " + QuarterList[i - 1] + " is " + ActualSeries.data[i].ToString() + ".");
                    }
                }
                if (GoalList != null && GoalList.Count > 0)
                {
        ...
        {
            Console.WriteLine("-------------- Monthly TQL Report -------------- \n \n");
            ...
            else
            {
                ...
                if (TotalActualList != null && TotalActualList.Count > 0)
                {
                    for (int i = 1; i <= TotalActualList.Count; i++)
                    {
                        ...
                        Assert.AreEqual(Math.Round(Convert.ToDecimal(ActualSeries.data[i].ToString()), 2), Math.Round(SumOfActual, 2));
                        Console.WriteLine("ReportController - GetRevenueData \n Report - Quarterly TQL Waterfall Report  \n The assert value of quarterly actual revenue in graph " + QuarterList[i - 1] + " is " + ActualSeries.data[i].ToString() + ".");
                    }
                }
                if (GoalList != null && GoalList.Count > 0)
                {
