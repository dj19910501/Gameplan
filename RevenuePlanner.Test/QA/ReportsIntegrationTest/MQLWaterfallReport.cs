 ...
 public  class MQLWaterfallReport
    {
        ...
        [TestMethod()]
        public void MQLWaterfallReportTest()
        {
            try
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < ActualList.Count(); i++)
                    {
                        ...
                        if (i % 4 < 0)
                        {
                            ...
                            Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of quaterly actual MQL is " + QuaterlyActualList[i % 4].ToString() + ".");
                            QuaActual = 0;
                        }
                    }
                }
            ...
            if (IsQuaterly == "Monthly")
            {
                ...
                for (int i = 1; i <= GoalList.Count; i++)
                {
                    if (i >= NewStartDate.Month && i + 1 <= NewEndDate.Month)
                    {
                        ...
                        Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of MQL goal is" + GoalList[i - 1].ToString() + ".");
                    }
                }
            }
            else
            {
                ...
                for (int i = 0; i < GoalList.Count(); i++)
                {
                    ...
                    if (i % 4 < 0)
                    {
                        ...
                        Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of quaterly MQL goal is" + QuaterlyGoalList[i % 4].ToString() + ".");
                        QuaGoal = 0;
                    }
                }
            }
            ...
            if (IsQuaterly == "Monthly")
            {
                ...
                for (int i = 1; i <= ActualList.Count(); i++)
                {
                    if (TQLStartDate.Month <= i && TQLEndDate.Month >= i)
                    {
                        ...
                        Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of MQL performance is " + PerformanceList[i - 1].ToString() + ".");
                    }
                    else
                    {
            ...
            else
            {
                ...
                for (int i = 0; i < PerformanceList.Count(); i++)
                {
                    ...
                    if (i % 4 < 0)
                    {
                        ...
                        Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of quaterly MQL performance is " + QuaterlyPerformanceList[i % 4].ToString() + ".");
                        QuaPerformance = 0;
                    }
                }
            }
                    ...
                    if (DateTime.Now.Date >= TacticStartDate && DateTime.Now.Date <= TacticEndDate)
                    {
                        ...
                        for (int i = 1; i <= GoalList.Count(); i++)
                        {
                            ...
                            if (DateTime.Now.Month == i)
                            {
                                ...
                                Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of projected MQL is " + ProjectedList[i - 1].ToString() + ".");
                            }
            ...
            else
            {
                ...
                for (int i = 0; i < ProjectedList.Count(); i++)
                {
                    ...
                    if (i % 4 < 0)
                    {
                        ...
                        Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of quaterly projected MQL is " + QuaterlyProjectedList[i % 4].ToString() + ".");
                        QuaProjected = 0;
                    }
                }
            }
            ...
            if (IsQuaterly == "Monthly")
            {
                for (int i = 1; i <= ActualList.Count(); i++)
                {
                    ...
                    if (i <= currentMonth)
                    {
                        ...
                        Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of total MQL is " + TotalActualList[i - 1].ToString() + ".");
                    }
                    else
                    {
            ...
            else
            {
                ...
                for (int i = 0; i < QuaterlyTotalActualList.Count(); i++)
                {
                    ...
                    if (i % 4 < 0)
                    {
                        ...
                        Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of quaterly total MQL is " + QuaterlyTotalActualList[i % 4].ToString() + ".");
                        QuaTotal = 0;
                    }
                }
            }
        ...
        public void VerifyWaterfall_MQLCardSection(List<double> ActualList)
        {
            ...
            Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of MQL actual in card section is " + Math.Round(CardMQLActual, 2).ToString() + ".");

            Assert.AreEqual(Math.Round(TacticTQL, 2), Math.Round(CardMQLGoal, 2));
            Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of MQL goal in card section is" + Math.Round(CardMQLGoal, 2).ToString() + ".");
            ...
            Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of MQL percentage in card section is " + Math.Round(CardMQLPercentage, 2).ToString() + ".");
        ...
        public void VerifyHeaderValue(Projected_Goal objProjected_Goal, List<double> ActualList, List<double> GoalList, List<double> ProjectedList)
        {
            ...
            Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of actual in header is " + objProjected_Goal.Actual_Projected + ".");
            ...
            Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of actual perecentage in header is " + objProjected_Goal.Actual_Projected + ".");
            ...
            Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of projected in header is " + Math.Round(TotalProjected, 2).ToString() + ".");
            ...
            Console.WriteLine("ReportController - GetTopConversionToPlanByCustomFilter \n The assert value of projected perecentage in header is " + Math.Round(ProjectedPercentage, 2).ToString() + ".");
