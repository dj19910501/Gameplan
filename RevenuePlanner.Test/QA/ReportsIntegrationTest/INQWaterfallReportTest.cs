...
namespace RevenuePlanner.Test.QA.ReportsIntegrationTest
{
    ...
    public class INQWaterfallReportTest
    {
                ...
                else
                {
                    ...
                    for (int i = 0; i < ActualList.Count(); i++)
                    {
                        ...
                        if (i % 4 < 0)
                        {
                            ...
                            Console.WriteLine("ReportController - GetRevenueData \n The assert value of quaterly actual inquiry is" + QuaterlyActualList[i % 4].ToString().ToString() + ".");
                            QuaActual = 0;
                        }
                    }
                }
            ...
            else
            {
                ...
                for (int i = 0; i < GoalList.Count(); i++)
                {
                    ...
                    if (i % 4 < 0)
                    {
                        ...
                        Console.WriteLine("ReportController - GetRevenueData \n The assert value of quaterly inquiry goal is " + GoalList[i % 4].ToString() + ".");
                        QuaGoal = 0;
                    }
                }
            }
            ...
            else
            {
                ...
                for (int i = 0; i < PerformanceList.Count(); i++)
                {
                    ...
                    if (i % 4 < 0)
                    {
                        ...
                        Console.WriteLine("ReportController - GetRevenueData \n The assert value of quaterly inquiry performance is" + QuaterlyPerformanceList[i % 4].ToString() + ".");
                        QuaPerformance = 0;
                    }
                }
            }
                    ...
                    if (DateTime.Now.Date >= TacticStartDate && DateTime.Now.Date <= TacticEndDate)
                    {
                        ...
                        for (int i = 1; i <= GoalList.Count(); i++)
                        {
                            ...
                            else if (DateTime.Now.Month < i)
                            {
                                ...
                                Console.WriteLine("ReportController - GetRevenueData \n The assert value of projected revenue is " + ProjectedList[i - 1].ToString() + ".");
                            }
                            else
                            {
            ...
            if (IsQuaterly == "Monthly")
            {
                for (int i = 1; i <= ActualList.Count(); i++)
                {
                    ...
                    if (i <= currentMonth)
                    {
                        ...
                        Console.WriteLine("ReportController - GetRevenueData \n The assert value of total inquiry is " + TotalActualList[i - 1].ToString() + ".");
                    }
                    else
                    {
            ...
            else
            {
                ...
                for (int i = 0; i < QuaterlyTotalActualList.Count(); i++)
                {
                    ...
                    if (i % 4 < 0)
                    {
                        ...
                        Console.WriteLine("ReportController - GetRevenueData \n The assert value of quaterely total inquiry is " + QuaterlyTotalActualList[i % 4].ToString() + ".");
                        QuaTotal = 0;
                    }
                }
            }
        ...
        public void VerifyWaterfall_INQCardSection(List<double> ActualList)
        {
            ...
            Console.WriteLine("ReportController - GetRevenueData \n The assert value of inquiry actual  is " + Math.Round(CardINQActual, 2).ToString() + ".");

            Assert.AreEqual(Math.Round(TacticINQ, 2), Math.Round(CardINQGoal, 2));
            Console.WriteLine("ReportController - GetRevenueData \n The assert value of inquiry actual goal is " + Math.Round(CardINQActual, 2).ToString() + ".");
            ...
            Console.WriteLine("ReportController - GetRevenueData \n The assert value of inquiry actual percentage is " + Math.Round(CardINQActual, 2).ToString() + ".");
